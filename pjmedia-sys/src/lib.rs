...
pub struct pjmedia_format__bindgen_ty_1 {
    ...
    pub user: __BindgenUnionField<[::std::os::raw::c_char; 1usize]>,
...
extern "C" {
    pub fn pjmedia_conf_get_msignal_level(
        conf: *mut pjmedia_conf,
        slot: ::std::os::raw::c_uint,
...
#[repr(C)]
pub struct pj_ice_msg_data_data {
    pub req: __BindgenUnionField<pj_ice_msg_data_data_request_data>,
