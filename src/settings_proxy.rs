...
impl HelperFileSettings for SettingsProxyWidget {
    ...
    fn save(&self, path: PathBuf) {
        ...
        config.set("proxy", "proxy1", Some(self.get_proxy1().to_string()));
        config.set("proxy", "proxy2", Some(self.get_proxy2().to_string()));
        config.set("proxy", "proxy3", Some(self.get_proxy3().to_string()));
        config.set("proxy", "proxy4", Some(self.get_proxy4().to_string()));
        config.set("proxy", "username1", Some(self.get_username1().to_string()));
        config.set("proxy", "username2", Some(self.get_username2().to_string()));
        config.set("proxy", "username3", Some(self.get_username3().to_string()));
        config.set("proxy", "username4", Some(self.get_username4().to_string()));
        config.set("proxy", "password1", Some(self.get_password1().to_string()));
        config.set("proxy", "password2", Some(self.get_password2().to_string()));
        config.set("proxy", "password3", Some(self.get_password3().to_string()));
        config.set("proxy", "password4", Some(self.get_password4().to_string()));
