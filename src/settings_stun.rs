...
impl HelperFileSettings for SettingsStunWidget {
    ...
    fn save(&self, path: PathBuf) {
        ...
        config.set("stun", "server1", Some(self.get_server1().to_string()));
        config.set("stun", "server2", Some(self.get_server2().to_string()));
        config.set("stun", "server3", Some(self.get_server3().to_string()));
        config.set("stun", "server4", Some(self.get_server4().to_string()));
        config.set("stun", "username1", Some(self.get_username1().to_string()));
        config.set("stun", "username2", Some(self.get_username2().to_string()));
        config.set("stun", "username3", Some(self.get_username3().to_string()));
        config.set("stun", "username4", Some(self.get_username4().to_string()));
        config.set("stun", "password1", Some(self.get_password1().to_string()));
        config.set("stun", "password2", Some(self.get_password2().to_string()));
        config.set("stun", "password3", Some(self.get_password3().to_string()));
        config.set("stun", "password4", Some(self.get_password4().to_string()));
