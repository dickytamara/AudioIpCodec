...
impl HelperFileSettings for SettingsIceWidget {
    fn load(&self, path: PathBuf) {
        ...
        self.set_use_rtcp(config.get("ice", "use_srtp").unwrap().parse().unwrap());
        self.set_reg_nomination(config.get("ice", "reg_nomination").unwrap().parse().unwrap());
    ...
    fn save(&self, path: PathBuf) {
        ...
        config.set("ice", "use_rtcp", Some(self.get_use_rtcp().to_string()));
        config.set("ice", "reg_nomination", Some(self.get_reg_nomination().to_string()));
