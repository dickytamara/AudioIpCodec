...
pub type media_stream = pjmedia_stream;
...
pub type media_frame = pjmedia_frame;
pub type media_frame_ext = pjmedia_frame_ext;
pub type media_frame_ext_subframe = pjmedia_frame_ext_subframe;
pub type media_aud_stream = pjmedia_aud_stream;
pub type media_aud_dev_factory = pjmedia_aud_dev_factory;
pub type media_aud_driver = pjmedia_aud_driver;
pub type media_aud_subsys = pjmedia_aud_subsys;
pub type media_aud_dev_info = pjmedia_aud_dev_info;
pub type media_aud_param = pjmedia_aud_param;
...
pub type media_event = pjmedia_event;
...
pub type media_port = pjmedia_port;
...
pub type media_transport_info = pjmedia_transport_info;
...
pub type media_wav_player_info = pjmedia_wav_player_info;
